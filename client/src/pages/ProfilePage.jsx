...
const ProfilePage = () => {
  ...
  return (
    <div>
      <AccountNav />
      {subpage === 'profile' && (
        <div className="m-20 flex flex-col items-center gap-8 rounded-[10px]  p-4 sm:h-1/5 sm:flex-row sm:items-stretch lg:gap-28 lg:pl-32 lg:pr-20">
          {/* avatar */}
          ...
          <div className="flex grow flex-col items-center gap-10 sm:items-start sm:justify-around sm:gap-0">
            ...
            {/* Action buttons */}
            <div className="flex sm:justify-end mb-40 sm:gap-5 md:gap-10">
              {/* <Button varient="secondary">Edit profile</Button> */}
              <EditProfileDialog />

              <Button className="currentColor hover:bg-blue-600" onClick={handleLogout}>
